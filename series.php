...
<?php
require_once 'incs/header_serie_search.php';
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <h4 class="gen-heading-title">Latest Series</h4>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-inline-block">
                    <div class="gen-movie-action">
                        <div class="gen-btn-container text-right">
                            <a href="all_series/latest" class="gen-button gen-button-flat">
                ...
                <div class="col-12">
                    <div class="gen-style-2">
                        <div id="renda" class="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="true"
                            ...
                            <?php
                            require_once 'incs/get_series.php';
                            $try = new series;
                            $try->get_series();
                            ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-inline-block">
                <div class="gen-movie-action">
                    <div class="gen-btn-container text-right">
                        <a href="all_series/trending" class="gen-button gen-button-flat">
                            <span class="text">View All</span>
                        </a>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            sform.addEventListener('submit',function(e){
                ...
                location.href=`series_search/${sterm}`;
            })
        });
    </script>
