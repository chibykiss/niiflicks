    ...
    public function getEmail($EM){
        ...
        if($send){
            ...
            if($exists == 1){
                ...
                $url = "http://localhost/niiflicks.com/reset_pass/new_pass/$selector/".bin2hex($token);
                ...
                if($exec){
                    $to = $this->email;
                    $subject = "Reset your Password for Niiflicks";
                    ...
                    $headers = "From: Niiflicks <no-reply@niiflicks.com>\r\n";
